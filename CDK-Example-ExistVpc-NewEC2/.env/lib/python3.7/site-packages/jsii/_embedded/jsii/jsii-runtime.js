...
function jsiiTypeFqn(obj) {
    ...
    return (_a = jsii) === null || _a === void 0 ? void 0 : _a.fqn;
}
    ...
    registerObject(obj, fqn, interfaces) {
        ...
        if (existingRef) {
            if (interfaces) {
                ...
                for (const iface of (_a = existingRef[api.TOKEN_INTERFACES], (_a !== null && _a !== void 0 ? _a : []))) {
                    allIfaces.add(iface);
                }
...
function propertiesOf(t, lookup) {
    ...
    for (const prop of (_a = t.properties, (_a !== null && _a !== void 0 ? _a : []))) {
        ret[prop.name] = prop;
    }
    return ret;
}
...
module.exports = JSON.parse("{\"name\":\"@jsii/runtime\",\"version\":\"0.20.11\",\"description\":\"jsii runtime kernel process\",\"license\":\"Apache-2.0\",\"author\":{\"name\":\"Amazon Web Services\",\"url\":\"https://aws.amazon.com\"},\"homepage\":\"https://github.com/aws/jsii\",\"bugs\":{\"url\":\"https://github.com/aws/jsii/issues\"},\"repository\":{\"type\":\"git\",\"url\":\"https://github.com/aws/jsii.git\",\"directory\":\"packages/@jsii/runtime\"},\"engines\":{\"node\":\">= 10.3.0\"},\"main\":\"lib/index.js\",\"types\":\"lib/index.d.ts\",\"bin\":{\"jsii-runtime\":\"bin/jsii-runtime\"},\"scripts\":{\"build\":\"tsc --build && chmod +x bin/jsii-runtime && /bin/bash ./bundle.sh && npm run lint\",\"watch\":\"tsc --build -w\",\"lint\":\"eslint . --ext .js,.ts --ignore-path=.gitignore --ignore-pattern=webpack.config.js\",\"test\":\"jest\",\"test:update\":\"jest -u\",\"package\":\"package-js\"},\"dependencies\":{\"@jsii/kernel\":\"^0.20.11\",\"@jsii/spec\":\"^0.20.11\"},\"devDependencies\":{\"@scope/jsii-calc-base\":\"^0.20.11\",\"@scope/jsii-calc-lib\":\"^0.20.11\",\"@types/jest\":\"^24.0.23\",\"@types/node\":\"^10.17.9\",\"eslint\":\"^6.7.2\",\"jest\":\"^24.9.0\",\"jsii-build-tools\":\"^0.20.11\",\"jsii-calc\":\"^0.20.11\",\"source-map\":\"^0.7.3\",\"source-map-loader\":\"^0.2.4\",\"typescript\":\"~3.7.3\",\"wasm-loader\":\"^1.3.0\",\"webpack\":\"^4.41.2\",\"webpack-cli\":\"^3.3.10\"},\"jest\":{\"collectCoverage\":true,\"collectCoverageFrom\":[\"**/bin/**/*.js\",\"**/lib/**/*.js\"],\"coverageReporters\":[\"lcov\",\"text\"],\"coverageThreshold\":{\"global\":{\"branches\":44,\"statements\":57}},\"errorOnDeprecated\":true,\"setupFilesAfterEnv\":[\"jest-expect-message\"],\"testEnvironment\":\"node\",\"testMatch\":[\"**/?(*.)+(spec|test).js\"]}}");
...
Object.defineProperty(exports, "__esModule", { value: true });
const kernel_1 = __webpack_require__(28);
...
class Kernel {
    ...
    load(req) {
        ...
        if (fs.pathExistsSync(packageDir)) {
            ...
            return {
                ...
                types: Object.keys((_a = assm.metadata.types, (_a !== null && _a !== void 0 ? _a : {}))).length,
            };
        }
        ...
        try {
            ...
            return {
                ...
                types: Object.keys((_b = assmSpec.types, (_b !== null && _b !== void 0 ? _b : {}))).length,
            };
        }
        finally {
    ...
    invoke(req) {
        ...
        const args = (_a = req.args, (_a !== null && _a !== void 0 ? _a : []));
        ...
        const result = this._fromSandbox(ret, (_b = ti.returns, (_b !== null && _b !== void 0 ? _b : 'void')));
    ...
    sinvoke(req) {
        ...
        return { result: this._fromSandbox(ret, (_b = ti.returns, (_b !== null && _b !== void 0 ? _b : 'void'))) };
    }
    begin(req) {
        var _a;
        const { objref, method } = req;
    ...
    async end(req) {
        ...
        return { result: this._fromSandbox(result, (_a = method.returns, (_a !== null && _a !== void 0 ? _a : 'void'))) };
    }
    callbacks(_req) {
    ...
    complete(req) {
        ...
        if (err) {
            ...
            const sandoxResult = this._toSandbox(result, (_a = cb.expectedReturnType, (_a !== null && _a !== void 0 ? _a : 'void')));
    ...
    _addAssembly(assm) {
        ...
        for (const fqn of Object.keys((_a = assm.metadata.types, (_a !== null && _a !== void 0 ? _a : {})))) {
    ...
    _create(req) {
        ...
        const requestArgs = (_a = req.args, (_a !== null && _a !== void 0 ? _a : []));
        ...
        const objref = this.objects.registerObject(obj, fqn, (_b = req.interfaces, (_b !== null && _b !== void 0 ? _b : [])));
    ...
    _defineOverridenProperty(obj, objref, override, propInfo) {
        ...
        const prev = (_a = Object.getOwnPropertyDescriptor(obj, propertyName), (_a !== null && _a !== void 0 ? _a : {
            value: undefined,
            writable: true,
            enumerable: true,
            configurable: true
        ...
        if (methodInfo.async) {
                ...
                value: (...methodArgs) => {
                    ...
                    return new Promise((succeed, fail) => {
                        ...
                        this.cbs[cbid] = {
                            ...
                            override,
                            args,
                            expectedReturnType: (_a = methodInfo.returns, (_a !== null && _a !== void 0 ? _a : 'void')),
                            succeed,
                            fail
                        };
                    });
            ...
            Object.defineProperty(obj, methodName, {
                ...
                value: (...methodArgs) => {
                    ...
                    return this._toSandbox(result, (_a = methodInfo.returns, (_a !== null && _a !== void 0 ? _a : 'void')));
                }
            });
        }
    }
    ...
    _validateMethodArguments(method, args) {
        var _a, _b;
        const params = (_b = (_a = method) === null || _a === void 0 ? void 0 : _a.parameters, (_b !== null && _b !== void 0 ? _b : []));
    ...
    _typeInfoForFqn(fqn) {
        ...
        const types = (_a = assembly.metadata.types, (_a !== null && _a !== void 0 ? _a : {}));
    ...
    _tryTypeInfoForMethod(methodName, classFqn, interfaces = []) {
        ...
        for (const fqn of [classFqn, ...interfaces]) {
            ...
            const typeinfo = this._typeInfoForFqn(fqn);
            const methods = (_a = typeinfo.methods, (_a !== null && _a !== void 0 ? _a : []));
            ...
            const bases = [typeinfo.base, ...(_b = typeinfo.interfaces, (_b !== null && _b !== void 0 ? _b : []))];
    ...
    _tryTypeInfoForProperty(property, classFqn, interfaces = []) {
        ...
        for (const fqn of [classFqn, ...interfaces]) {
            ...
            if (spec.isClassType(typeInfo)) {
                ...
                bases = (_a = interfaceTypeInfo.interfaces, (_a !== null && _a !== void 0 ? _a : []));
            }
            else {
...
function isClassType(type) {
    var _a;
    return ((_a = type) === null || _a === void 0 ? void 0 : _a.kind) === TypeKind.Class;
}
exports.isClassType = isClassType;
function isInterfaceType(type) {
    var _a;
    return ((_a = type) === null || _a === void 0 ? void 0 : _a.kind) === TypeKind.Interface;
}
exports.isInterfaceType = isInterfaceType;
function isEnumType(type) {
    var _a;
    return ((_a = type) === null || _a === void 0 ? void 0 : _a.kind) === TypeKind.Enum;
}
...
function isDeprecated(entity) {
    var _a, _b;
    return ((_b = (_a = entity) === null || _a === void 0 ? void 0 : _a.docs) === null || _b === void 0 ? void 0 : _b.stability) === Stability.Deprecated;
}
...
class NameTree {
    ...
    static of(assm) {
        ...
        for (const type of Object.values((_a = assm.types, (_a !== null && _a !== void 0 ? _a : {})))) {
